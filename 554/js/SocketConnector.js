...
SocketConnector.prototype.retrieveStartupData = function () {
	...
	this.socket.send("getInitData", {
		...
		console.log("getInitData===", a);
		console.log("getInitData===", b);
