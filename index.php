...
<head>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2jF_QtI3z-3Lq61DFiIjIHK5PpfcC4Bg" type="text/javascript"></script>
    ...
    <script type="text/javascript">
	    ...
	    var GLOBAL_SOCKET_SERVER    = "asa11.tawk.to";
	    var GLOBAL_SOCKET_SERVER_URL = "/s";
	    ...
	    var LOGERROR                = "yes";
	    var UI_VERSION              = "554";
	    var SESSION_KEY             = "5abb2729ce4b8b0e84594a5c";
		...
		var markdownConverter = new showdown.Converter({tables : true, simplifiedAutoLink : true, simpleLineBreaks : true, extensions : ['targetBlank']});
    ...
    <!--    <script src="554/js/app.min1.js" crossorigin="anonymous"></script>-->
